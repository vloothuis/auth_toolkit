defmodule AccountToolkit.Migrations.V01 do
  ...
  def up(_) do
    ...
    create table(:account_toolkit_users) do
    ...
    create table(:account_toolkit_users_tokens) do
      add(:user_id, references(:account_toolkit_users, on_delete: :delete_all), null: false)
    ...
    create table(:account_toolkit_user_confirmation_codes, primary_key: false) do
