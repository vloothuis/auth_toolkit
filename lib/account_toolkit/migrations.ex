defmodule AccountToolkit.Migrations do
  @moduledoc false
  ...
  def migrated_version(opts) do
    ...
    WHERE pg_class.relname = 'account_toolkit_users'
  ...
  defp record_version(%{prefix: prefix}, version) do
    execute("COMMENT ON TABLE #{inspect(prefix)}.account_toolkit_users IS '#{version}'")
  end
